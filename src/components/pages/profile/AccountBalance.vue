            ...
            <div v-if="accountBalance != null">
                <div class="row">
                    <div class="col-12 col-sm-6">
                        ...
                        <h1>CHF {{ accountBalance }}</h1>
                        <a v-if="!showPayoutForm" @click="showPayout" class="btn primary-bg">{{$t('Request a payout')}}</a>
                    ...
                    <div v-if="showPayoutForm" class="col-12 col-sm-6">
                        <div v-if="payoutInfo == null || payoutInfo.payoutMode != 1">
                            <div class="form-group">
                                ...
                                <span v-show="errors.has('bank')"
                                      class="text-danger">{{ errors.first('bank') }}</span>
                            </div>
                            <div class="form-group">
                                <label>
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                e: { // errors
                    zeroPayout: this.$t('No payouts can be made: CHF 0.'),
