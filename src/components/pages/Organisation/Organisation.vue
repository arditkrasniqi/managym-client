        ...
        <h1 class="page-title">
            ...
            <div class="btn-group organisation-settings" style="float:right;" v-if="org.trainers.length > 0">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a v-if="org.authRole == 'owner'" class="dropdown-item" data-href="assignPrograms"
                        @click="setId">{{ $t('Assign Programs') }}</a>
        ...
        <div class="card">
            <div class="card-block">
                ...
                <div v-else>
                    ...
                    <div
                        v-if="org.status == 1 || userStore.info.id == org.owner.id || userStore.info.userId == org.owner.id || org.authRole == 'client'">
                            ...
                            <table class="table table-hover table-sm">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <p class="role">{{ org.owner.organisationRole }}</p>
                                        </td>
                                    ...
                                    <tr v-for="trainer in org.trainers">
                                        ...
                                        <td>
                                            ...
                                            <div v-else-if="org.authRole == 'admin'">
                                                <select @change="roleChange(org.id, trainer, trainer.organisationRoleId)"
                                                    class="form-control" v-model="trainer.organisationRoleId">
                                        ...
                                        <td class="icons">
                                            <a href="javascript:void(0)" @click="updateModal(trainer.id, 'other')"
                                                data-toggle="modal" data-target="#trainerInfoModal">
                                                <i class="fa fa-user"></i>
                                            </a>
                                        </td>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span v-show="errors.has('availFrom')"
                                            class="text-danger">{{ errors.first('availFrom') }}</span>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <span v-show="errors.has('availTo')"
                                            class="text-danger">{{ errors.first('availTo') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default {
    ...
    created() {
        ...
        this.loadData();
        let vm = this;
        axios.get(process.env.api_hostname + "/getTrainersList").then(response => {
    ...
    methods: {
        updateTrainerSettings() {
            this.$validator.validateAll().then(result => {
                if (result) {
                    ...
                    axios.post(`${process.env.api_hostname}/updateTrainerWorkingHours`,
                        {
        ...
        loadData() {
            ...
            let vm = this;
            axios
                .post(process.env.api_hostname + "/getOrganisationById", {
                    id: this.org.id
                })
                .then(response => {
        ...
        removeTrainer(id) {
            this.$swal({
                ...
                result => {
                    axios
                        .post(process.env.api_hostname + "/removeTrainerFromOrganisations", {
                            trainerId: id,
                            orgId: this.org.id
                        })
                        .then(response => {
        ...
        closeOrganisation(id) {
            this.$swal({
                ...
                result => {
                    axios
                        .post(process.env.api_hostname + "/closeOrganisation", {
                            orgId: id
                        })
                        .then(response => {
                            this.$notify({
        ...
        setInvitation(id, status) {
            axios
                .post(process.env.api_hostname + "/setInvitation", {
        ...
        getAutoLoadData() {
            let vm = this;
            axios
                .get(process.env.api_hostname + "/organisationComponentData")
                .then(res => {
        ...
        roleChange(org, user, role) {
            if (this.org.authRole == "owner" && role == 1) {
                this.$swal({
                    ...
                    result => {
                        axios
                            .post(process.env.api_hostname + "/setOrganisationMemberRole", {
                                orgId: org,
                                userId: user.id,
                                roleId: role
                            })
        ...
        addTrainers() {
            ...
            axios
                .post(process.env.api_hostname + "/addTrainers", {
                    orgId: vm.org.id,
