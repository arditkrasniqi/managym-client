                ...
                <div class="modal-content">
                    ...
                    <form @submit.prevent="editProgram">
                        <div class="modal-body" v-if="showTrainersEdit">
                            ...
                            <div class="form-group">
                                <a @click="showAddTrainer" v-if="!showAddTrainerForm" href="javascript:void(0)"
                                ...
                                <div class="row add-trainer-form" v-else>
                                    <div class="col-12 col-sm-7">
                                        <select v-model="newTrainer" class="form-control">
                                            ...
                                            <option v-for="orgTrainer in organisationTrainers" :value="orgTrainer.id">
                                                {{ orgTrainer.firstname }} {{ orgTrainer.lastname }}</option>
                                        </select>
                                    </div>
