    ...
    <div>
        <div class="card">
            <div class="card-block">
                <full-calendar @dayClick="dayClick" @eventClick="eventClick" v-if="fcEvents != null" :events="fcEvents" :locale="lang" :weekNames="weeks" :monthNames="months">
                </full-calendar>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            <span v-if="currentAppointment.status == 1 && currentAppointment.paymentStatus == 0">{{ $t('Payment is pending') }}</span>
                            <span v-else>{{ $t('Edit Appointment') }}</span>
                        </h4>
                    </div>
                    <form v-if="currentAppointment.status == 0  && currentAppointment.paymentStatus == 0 || currentAppointment.status == 1  && currentAppointment.paymentStatus == 1"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="form-group" v-if="1 > 2">
                                        <label>{{ $t('Appointment is gonna last until') }}</label><div class="row">
                                            <div class="col-6">
                                    ...
                                    <div class="form-group" v-show="programs.showTrainerProgramsList == 1">
                                        <label>Program</label>
                                        <select id="trainerProgramsList" v-validate="'required|numeric'" data-vv-as="Program" name="program"
