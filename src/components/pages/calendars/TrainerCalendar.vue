<template>
    <div>
        <div v-if="trainerPlan.calendarAccess">
            <div class="card">
                <div class="card-block">
                    <full-calendar @dayClick="dayClick" @eventClick="eventClick" v-if="fcEvents != null" :events="fcEvents"
                                   :locale="lang" :weekNames="weeks" :monthNames="months"></full-calendar>
                </div>
            </div>
        </div>
        <div v-else>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-sm primary-bg" @click="goToCard(2)">{{$t('Choose Plan')}}</button>
                                    </td>
                                    <td class="text-center">
                                        <button class="btn btn-sm primary-bg" @click="goToCard(3)">{{$t('Choose Plan')}}</button>
                                    </td>
                                    <td class="text-center">
                                        <button class="btn btn-sm primary-bg" @click="goToCard(4)">{{$t('Choose Plan')}}</button>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" id="payForm">
                            <div class="form-group">
                                ...
                                <input v-validate="'required|credit_card'" name="credit_card" :data-vv-as="$t('Credit Card Number')" type="number" v-model="card.number" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <input v-validate="'required|min_value:1|max_value:12'" type="number" name="exp_month" :data-vv-as="$t('Month')" v-model="card.expMonth" class="form-control">
            ...
            <div v-else>
                ...
                <div class="card bg-faded">
                    <div class="card-block calendar-info">
                        ...
                        <button @click="showPlans" class="btn primary-bg">{{$t('Go To Plans')}} <i class="fa fa-arrow-right"></i>
                        </button>
                    </div>
                </div>
            </div>
                            ...
                            <div v-if="!showEditAppointment" class="row">
                                <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        <div class="table-responsive">
                                            <table class="table table-sm table-striped">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span v-if="currentAppointment.paymentStatus == 1">{{$t('Paid')}}</span>
                                                ...
                                                <tr>
                                                    <th>{{$t('Total Price')}}</th>
                                                    <td>
                                                        <span v-if="currentAppointment.trainerPrice != null">CHF {{ currentAppointment.trainerPrice }}</span>
                                        ...
                                        <div v-if="currentAppointment.paymentStatus != 1 && currentAppointment.createdBy == 'trainer'">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span v-show="errors.has('Trainer')" class="text-danger">{{ errors.first('Trainer') }}</span>
                                    </div>
                                    <div class="form-group">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            axios.get(config.api_hostname + "/customersList").then(response => {
        ...
        methods: {
            ...
            loadPrograms() {
                ...
                let vm = this;
                axios.get(config.api_hostname + '/getProgramsByTrainerId/' + vm.userStore.info.userId).then(response => {
            ...
            updatePrice() {
                ...
                axios
                    .post(config.api_hostname + "/setTrainerPrice", {
            ...
            getAppointments() {
                let vm = this;
                axios.get(config.api_hostname + "/trainerAppointments").then(response => {
                    vm.fcEvents = response.data.data;
                    vm.fcEvents.map(event => {
                        if(event.status == 0){
