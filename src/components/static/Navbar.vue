            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                ...
                <div class="btn-group" v-if="userStore.info">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <router-link v-if="userStore.role === 'customer'" to="/become-trainer">
                            {{ $t('Become a Trainer') }}</router-link>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <input type="text" id="affiliateLink" :value="userStore.affiliateLink"
                                        class="form-control">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer mf">
                        <button @click="copyAffiliateLink" type="button" class="btn primary-bg"
                            data-dismiss="modal">{{ $t('Copy to Clipboard') }}</button>
                    </div>
                </div>
