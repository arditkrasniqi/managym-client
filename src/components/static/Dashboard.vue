        ...
        <div v-if="userStore.role != 'admin'">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tr v-for="appointment in appointments">
                                    <td @click="appointmentDetails(appointment.id)" class="pointer">{{ appointment.description }}</td>
            ...
            <div v-else>
                ...
                <div class="create-appointment">
                    <p v-if="userStore.role == 'customer'">{{$t('Go to calendar and create new appointments with the best Trainers near you')}}.</p>
                    <p v-else>{{$t('Go to calendar and confirm any appointment request or create new appointments')}}.</p>
        ...
        <div id="notifyForTrainer" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn primary-bg" @click="becomeTrainer">{{$t('I want to become Trainer')}}</button>
                        <button type="button" class="btn btn-default" @click="dismissNotification" data-dismiss="modal">{{$t('Cancel')}}</button>
                    </div>
                </div>
    ...
    export default {
        ...
        methods: {
            dismissNotification(){
                ...
                axios.post(`${config.api_hostname}/disableNotificationForTrainer`,{
                    status:0,
            ...
            trainerAppointments() {
                let vm = this;
                axios
                    .get(config.api_hostname + "/dashboardTrainerAppointments")
                    .then(response => {
            ...
            customerAppointments() {
                let vm = this;
                axios
                    .get(config.api_hostname + "/dashboardCustomerAppointments")
                    .then(response => {
                        vm.appointments = response.data;
                    });
            },
